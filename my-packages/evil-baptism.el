...
(define-key evil-ex-completion-map "A-p" #'previous-complete-history-element)
(define-key evil-ex-completion-map "A-n" #'next-complete-history-element)
(define-key evil-ex-completion-map "A-h" #'select-from-history)
